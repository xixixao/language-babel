...
Ó      acosh: function acosh(x) {
      ...
      sinh: function sinh(x) {
        return abs(x) < 1 ? (expm1(x) - expm1(-x) ) / 2 : (exp(x - 1) - exp(-x - 1)) * (E / 2);
      },
  ...
  61: [function(require, module, exports) {
    ...
    $.each.call(('freeze,seal,preventExtensions,isFrozen,isSealed,isExtensible,' +
      'getOwnPropertyDescriptor,getPrototypeOf,keys,getOwnPropertyNames').split(','), function(KEY, ID) {
